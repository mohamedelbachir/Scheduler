...
enum ScheduleGroup{PREEMPTIF,NOPREEMPTIF};

enum ScheduleType{/*No Preemptif*/SCH_FCFS,SCH_SJF,/*Preemptif*/SCH_SRTF,SCH_RR};

enum AlgoGenerationType{ALG_DEFAULT,ALG_ALPHA,ALG_ALPHA_NUM,ALG_NUM};
